...
urlpatterns = [
    ...
    path("entra/conversions/", views.conversions, name="conversions"),
    path("entra/conversions/<int:level_id>/", views.level_convert, name="level_convert"),
    ...
    path("entra/admin/reconcile/", views.reconcile_now, name="reconcile_now"),
    path("entra/admin/routes/", views.route_list, name="route_list"),
    path("entra/admin/routes/<int:pk>/", views.route_update, name="route_update"),
    path("entra/admin/routes/<int:pk>/delete/", views.route_delete, name="route_delete"),
