...
urlpatterns = [
    ...
    path("directory/accounts/", views.account_list, name="account_list"),
    path("directory/accounts/<int:pk>/link/", views.account_link, name="account_link"),
    path("directory/accounts/<int:pk>/unlink/", views.account_unlink, name="account_unlink"),
    path("directory/accounts/<int:pk>/kind/", views.account_kind, name="account_kind"),
